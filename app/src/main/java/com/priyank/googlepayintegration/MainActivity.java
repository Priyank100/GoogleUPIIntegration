package com.priyank.googlepayintegration;
...
//    String GOOGLE_PAY_PACKAGE_NAME = "com.google.android.apps.nbu.paisa.user";  // For GooglePay Only
    ...
    void payUsingUpi(String name, String upiId, String note, String amount) {
        Log.e("GooglePay>> ", name + "==" + upiId + "==" + note + "==" + amount);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("GooglePay>> ", "response=" + resultCode );
